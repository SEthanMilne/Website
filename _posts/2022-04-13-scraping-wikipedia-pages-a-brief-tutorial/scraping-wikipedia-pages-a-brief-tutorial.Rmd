...
Scraping tables takes a single line of code. The `htmltab()` function uses two inputs: a link to the webpage, and a number marking which table you want to scrape. In this case, I want to get table #1, which is a summary of the Big Bang Theory seasons.
